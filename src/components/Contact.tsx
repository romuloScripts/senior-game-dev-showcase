...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gaming-bg-secondary">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gaming-text-muted max-w-3xl mx-auto">
              Ready to create something amazing together? I'm always interested in discussing 
              new opportunities, collaborations, or just chatting about game development.
            </p>
          </div>
