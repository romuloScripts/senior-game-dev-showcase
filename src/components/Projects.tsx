...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gaming-bg-primary">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <Card className="p-6 text-center bg-gradient-card border-gaming-bg-tertiary">
              <div className="text-3xl font-bold text-gaming-primary mb-2">50+</div>
            ...
            <Card className="p-6 text-center bg-gradient-card border-gaming-bg-tertiary">
              <div className="text-3xl font-bold text-gaming-primary mb-2">150+</div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <Card 
                key={index} 
                className={`p-6 bg-gradient-card border-gaming-bg-tertiary hover:shadow-gaming transition-all duration-300 ${
                  project.featured ? 'ring-2 ring-gaming-primary/50' : ''
                }`}
              >
                {/* Project Header */}
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {project.featured && (
                        <span className="bg-gaming-primary text-gaming-bg-primary px-2 py-1 rounded text-xs font-semibold">
                          Featured
                        </span>
                      )}
                    </div>
